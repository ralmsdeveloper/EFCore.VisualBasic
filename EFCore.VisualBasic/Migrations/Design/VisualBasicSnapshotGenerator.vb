    ...
    Protected Overridable Sub GeneratePropertyAnnotations([property] As IProperty,
        ...
        If valueConverter IsNot Nothing Then
            ...
            If hints IsNot Nothing Then
                ...
                If TypeOf hints Is RelationalConverterMappingHints Then
                    Dim relationalHints = CType(hints, RelationalConverterMappingHints)
                    If relationalHints IsNot Nothing And relationalHints.IsFixedLength IsNot Nothing Then
